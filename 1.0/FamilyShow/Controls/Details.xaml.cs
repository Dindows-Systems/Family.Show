...
namespace Microsoft.FamilyShow
{
    ...
    public partial class Details : System.Windows.Controls.UserControl
    {
        ...
        public Details()
        {
            ...
            // Binding for the family member count.
            Binding bind = new Binding("Count");
            bind.Source = family;
            FamilyMemberCountTextBlock.SetBinding(TextBlock.TextProperty, bind);   
        ...
        private void FamilyListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (!ignoreSelection)
            {
                ...
                family.Current = (Person)((ListBox)sender).SelectedItem;
        ...
        private void Sort(string sortBy, ListSortDirection direction)
        {
            ICollectionView dataView =
              CollectionViewSource.GetDefaultView(FamilyListView.ItemsSource);
